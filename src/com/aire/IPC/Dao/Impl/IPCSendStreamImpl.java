...
public class IPCSendStreamImpl implements IPCSendStreamDao {
	...
	private Boolean SendStreamBaseWindows(String ip, String username, String password, String id, String ServerIP) {
//		String cmdStr = "ffmpeg -i rtsp://" + username + ":" + password + "@" + ip
//				+ "/h264/ch1/sub/av_stream -f flv -an rtmp://" + ServerIP + "/live/" + id;
		//Test
		String cmdStr = "ffmpeg -i rtsp://" + username + ":" + password + "@" + ip
				+ "/h264/ch1/sub/av_stream -f flv -an rtmp://" + ServerIP + "/live/" + "test898";
	...
	private Boolean SendStreamBaseLinux(String ip, String username, String password, String id, String ServerIP) {
//		String cmdStr = "ffmpeg -i rtsp://" + username + ":" + password + "@" + ip
//				+ "/h264/ch1/sub/av_stream -f flv -b:v 20k -r 20 -s 640x480 -c:a copy rtmp://" + ServerIP + "/live/" + id;
		//Test
		String cmdStr = "ffmpeg -i rtsp://" + username + ":" + password + "@" + ip
				+ "/h264/ch1/sub/av_stream -f flv -b:v 20k -r 20 -s 640x480 -c:a copy rtmp://" + ServerIP + "/live/" + "test898";
	...
	@Override
	public Boolean SendStream(String ip, String username, String password, String id, String ServerIP) {
		if (getOSName().equals("windows")) {
			SendStreamBaseWindows(ip, username, password, id, ServerIP);
		} else {
			SendStreamBaseLinux(ip, username, password, id, ServerIP);
		}
		return null;
	}
