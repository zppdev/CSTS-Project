...
//			System.out.println(password + "||" + username + "@@" + serverIP);
	...
	public void sendStreamForIPC(@RequestParam("ip") String localIP, @RequestParam("id") String id, @RequestParam("username") String username, @RequestParam("password") String password, @RequestParam("serverIP") String serverIP) {
		System.out.println(localIP);
		System.out.println(id);
		ipcSendStreamDao.SendStream(localIP, username, password, id, serverIP);
	}
}
